...
- (void)initMyWindow{
    ...
    if (usernameStr.length>0) {
        ...
        self.window.rootViewController = [[POHNavViewController alloc] initWithRootViewController:[POHMainViewController new]];
    }else{
        self.window.rootViewController = [POHLoginViewController new];
    }
